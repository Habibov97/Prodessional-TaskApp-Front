...
export default function CompletedTask() {
  return (
    <div className="col-start-2 row-start-3 row-span-3 shadow-[0_0_25px_rgba(0,0,0,0.08)] flex flex-col items-center max-h-[372px] rounded-xl text-xl pt-[12px] pb-[20px] px-10">
